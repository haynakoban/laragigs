        ...
        <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <p class="text-sm font-light text-gray-500" style="margin-top: 0 !important" style="font-family: 'Inter', 'Poppins' !important;">
                    Don’t have an account yet? <a href="/register" class="font-medium text-blue-600 hover:underline" style="font-family: 'Inter', 'Poppins' !important;">Sign up</a>
                </p>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="remember" class="text-gray-500" style="font-family: 'Inter', 'Poppins' !important;">Remember me</label>
                            </div>
                        </div>
                        <a href="#" class="text-sm font-medium text-blue-600 hover:underline" style="font-family: 'Inter', 'Poppins' !important;">Forgot password?</a>
                    </div>
                    <button type="submit" class="w-full text-white bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" style="font-family: 'Inter', 'Poppins' !important;">Sign in</button>
                </form>
